 ...
 */
// NOTE: added an additional argument here to skip rendering
// this is for the test which checks that all feeds load
function loadFeed(id, cb, skipRender) {
  ...
  feed.load(function (result) {
    if (!result.error) {
       ...
       */
      // if skipRender is falsy then go ahead and render the output
      if (!skipRender) {
        var container     = $('.feed'),
            title         = $('.header-title'),
    ...
    // NOTE: added returning the result via the callback
